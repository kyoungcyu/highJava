...
public class T06WildCardTest {
	...
	/**
	 * 장바구니 항목조회를 위한 메소드 (고기류나 그 상위 항목)
	 */
	public static void displayCartItemInfo3(Cart<? super Meat> cart) {
		System.out.println(" = 고기류 or 상위 장바구니 항목 리스트 =");
		for (Object obj : cart.getList()) {
			System.out.println(obj.toString());
		}
		System.out.println("-------------------------------------------------");
	...
	public static void main(String[] args) {
		...
		foodCart.add(new Coffee("아이스아메리카노", 5000));
		...
		drinkCart.add(new Coffee("아이스아메리카노", 5000));
