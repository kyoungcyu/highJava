...
//        scan.nextLine(); // 입력버퍼에 남아있는 엔터키값(개행) 제거하기
    ...
    private void update() {
        ...
        // 이미 등록된 사람인지 검사하기
        if (phoneBook.get(name) == null) {
            System.out.println(name + "씨는 이미 등록되지 않은 정보입니다.");
...
//        scan.nextLine(); // 입력버퍼에 남아있는 엔터키값(개행) 제거하기
    ...
    private void delete() {
        ...
        //remove(key) => 삭제 성공하면 삭제된 value 값 리턴, 실패하면 null 반환
